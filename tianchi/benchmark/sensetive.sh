...
bash start_exps_eval.sh "DLRM" "DLRM_directio"
...
bash start_exps_eval.sh "DLRM" "DLRM_lfu"
...
sed -i 's/AAAAAAAAAAAAAAAB32LFUBBBBBBBBBBB/B32LFU/g' /home/axy/code/aoxy/DeepRec/tianchi/DLRM/train.py
bash start_exps_eval.sh "DLRM" "DLRM_mmap_and_madvise"
...
sed -i 's/AAAAAAAAAAAAAAAB32LFUBBBBBBBBBBB/B32LFU/g' /home/axy/code/aoxy/DeepRec/tianchi/DLRM/train.py
bash start_exps_eval.sh "DLRM" "DLRM_mmap"
