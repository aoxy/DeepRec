...
record_one_train() {
    ...
    python3 train.py --no_eval --storage_type=$storage_type 1> $log_dir/train_dlrm_log/dlrm_log_$path_cache_cap.txt 2>&1 &
    cpp_pid=$!
    ...
    echo "Train with $storage_type and [$cache_cap] x100MB Cache done. $(pwd)"
    rm -rf temp_emb/*
}
...
mkdir -p /home/code/models_metrics/DLRM
mv $log_dir /home/code/models_metrics/DLRM
...
# SIZE = [1343323, 2557, 82589, 4987656]
# SIZE * 1552 / 1024 / 1024 = [1989, 4, 123, 7383]
mkdir -p /home/code/models_metrics/MMoE
mv $log_dir /home/code/models_metrics/MMoE
...
# SIZE = [1343323, 2557, 82589, 4987656]
# SIZE * 1552 / 1024 / 1024 = [1989, 4, 123, 7383]
mkdir -p /home/code/models_metrics/WDL
mv $log_dir /home/code/models_metrics/WDL
...
# SIZE = [1343323, 2557, 82589, 4987656]
# SIZE * 1552 / 1024 / 1024 = [1989, 4, 123, 7383]
mkdir -p /home/code/models_metrics/DIEN
mv $log_dir /home/code/models_metrics/DIEN
